...
win:
	go build \
	-ldflags="-X 'deamchain-graphql/cmd/apiserver/build.Version=$(APP_VERSION)' -X 'deamchain-graphql/cmd/apiserver/build.Time=$(BUILD_DATE)' -X 'deamchain-graphql/cmd/apiserver/build.Compiler=$(BUILD_COMPILER)' -X 'deamchain-graphql/cmd/apiserver/build.Commit=$(BUILD_COMMIT)' -X 'deamchain-graphql/cmd/apiserver/build.CommitTime=$(BUILD_COMMIT_TIME)'" \
