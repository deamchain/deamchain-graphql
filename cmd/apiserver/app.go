...
import (
	"deamchain-graphql/cmd/apiserver/build"
	"deamchain-graphql/internal/config"
	"deamchain-graphql/internal/graphql/resolvers"
	"deamchain-graphql/internal/handlers"
	"deamchain-graphql/internal/logger"
	"deamchain-graphql/internal/repository"
	"deamchain-graphql/internal/svc"
	"flag"
	"log"
	"net/http"
	"os"
...
func (app *apiServer) run() {
	...
	app.log.Infof("welcome to DeamChain GraphQL API server")
