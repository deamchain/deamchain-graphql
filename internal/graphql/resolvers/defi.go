...
import (
	"deamchain-graphql/internal/repository"
...
// defiDEAMSymbol is the symbol used for wrapped DEAM tokens.
const defiDEAMSymbol = "DEAM"
...
// DefiNativeToken resolves the native DEAM wrapper token.
...
// CanWrapDEAM signals if the token can be used to wrap native DEAM
// to get some amount of it.
func (dt *DefiToken) CanWrapDEAM() bool {
	return dt.Symbol == defiDEAMSymbol
}
