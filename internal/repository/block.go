...
import (
	"deamchain-graphql/internal/repository/cache"
	"deamchain-graphql/internal/repository/rpc"
...
var ErrBlockNotFound = errors.New("requested block can not be found in DEAM blockchain")
...
// BlockByNumber returns a block at DEAM blockchain represented by a number. Top block is returned if the number
// is not provided.
...
// BlockByHash returns a block at DEAM blockchain represented by a hash. Top block is returned if the hash
// is not provided.
// If the block is not found, ErrBlockNotFound error is returned.
...
// blockByTag returns a block at DEAM blockchain represented by given tag.
