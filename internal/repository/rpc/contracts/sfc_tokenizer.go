...
var SfcTokenizerMetaData = &bind.MetaData{
	ABI: "[{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"_updateSDEAMTokenAddress\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"}],\"name\":\"allowedToWithdrawStake\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"}],\"name\":\"checkAllowedToWithdrawStake\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"redeemSDEAM\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"outstandingSDEAM\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"sDEAMTokenAddress\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"renounceOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"initialize\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"isOwner\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"toStakerID\",\"type\":\"uint256\"}],\"name\":\"mintSDEAM\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"}]",
}
...
// OutstandingSDEAM is a free data retrieval call binding the contract method 0x5b04f4c8.
//
// Solidity: function outstandingSDEAM(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerCaller) OutstandingSDEAM(opts *bind.CallOpts, arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _SfcTokenizer.contract.Call(opts, &out, "outstandingSDEAM", arg0, arg1)
...
//
// Solidity: function outstandingSDEAM(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerSession) OutstandingSDEAM(arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	return _SfcTokenizer.Contract.OutstandingSDEAM(&_SfcTokenizer.CallOpts, arg0, arg1)
}

// OutstandingSDEAM is a free data retrieval call binding the contract method 0x5b04f4c8.
//
// Solidity: function outstandingSDEAM(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerCallerSession) OutstandingSDEAM(arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	return _SfcTokenizer.Contract.OutstandingSDEAM(&_SfcTokenizer.CallOpts, arg0, arg1)
}
...
// SDEAMTokenAddress is a free data retrieval call binding the contract method 0x693c5e24.
//
// Solidity: function sDEAMTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerCaller) SDEAMTokenAddress(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SfcTokenizer.contract.Call(opts, &out, "sDEAMTokenAddress")
...
//
// Solidity: function sDEAMTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerSession) SDEAMTokenAddress() (common.Address, error) {
	return _SfcTokenizer.Contract.SDEAMTokenAddress(&_SfcTokenizer.CallOpts)
}

// SDEAMTokenAddress is a free data retrieval call binding the contract method 0x693c5e24.
//
// Solidity: function sDEAMTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerCallerSession) SDEAMTokenAddress() (common.Address, error) {
	return _SfcTokenizer.Contract.SDEAMTokenAddress(&_SfcTokenizer.CallOpts)
}

// UpdateSDEAMTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSDEAMTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) UpdateSDEAMTokenAddress(opts *bind.TransactOpts, addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "_updateSDEAMTokenAddress", addr)
}

// UpdateSDEAMTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSDEAMTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerSession) UpdateSDEAMTokenAddress(addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.UpdateSDEAMTokenAddress(&_SfcTokenizer.TransactOpts, addr)
}

// UpdateSDEAMTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSDEAMTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) UpdateSDEAMTokenAddress(addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.UpdateSDEAMTokenAddress(&_SfcTokenizer.TransactOpts, addr)
}
...
// MintSDEAM is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSDEAM(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) MintSDEAM(opts *bind.TransactOpts, toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "mintSDEAM", toStakerID)
}

// MintSDEAM is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSDEAM(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerSession) MintSDEAM(toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.MintSDEAM(&_SfcTokenizer.TransactOpts, toStakerID)
}

// MintSDEAM is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSDEAM(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) MintSDEAM(toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.MintSDEAM(&_SfcTokenizer.TransactOpts, toStakerID)
}

// RedeemSDEAM is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSDEAM(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) RedeemSDEAM(opts *bind.TransactOpts, stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "redeemSDEAM", stakerID, amount)
}

// RedeemSDEAM is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSDEAM(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerSession) RedeemSDEAM(stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.RedeemSDEAM(&_SfcTokenizer.TransactOpts, stakerID, amount)
}

// RedeemSDEAM is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSDEAM(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) RedeemSDEAM(stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.RedeemSDEAM(&_SfcTokenizer.TransactOpts, stakerID, amount)
}
